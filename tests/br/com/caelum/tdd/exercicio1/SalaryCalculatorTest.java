...
public class SalaryCalculatorTest {
	...
	@Test
	public void deveRetornarSalarioMenosImpostosDe20PorCentoSeGerenteGanhaMaisDe5000(){
		Employee gerente = umFuncionario(MANAGER, comSalarioBase(5001.0));
		
		double salary = calculator.calculate(gerente);
		
		assertEquals(5001.0 * 0.8, salary, 0.000001);
	}
	
	@Test
	public void deveRetornarSalarioMenosImpostosDe20PorCentoSeGerenteGanhaIgualA5000(){
	...
	@Test
	public void deveRetornarSalarioMenosImpostosDe15PorCentoSeGerenteGanhaMenosDe5000(){
		Employee gerente = umFuncionario(MANAGER, comSalarioBase(4999.0));
		
		double salary = calculator.calculate(gerente);
		
		assertEquals(4999.0 * 0.85, salary, 0.000001);
	}
	
	@Test
	public void deveRetornarZeroSeGerenteGanhaIgualAZero(){
		Employee gerente = umFuncionario(MANAGER, comSalarioBase(0.0));
		
		double salary = calculator.calculate(gerente);
		
		assertEquals(0, salary, 0.000001);
	}
